...
import com.amazonaws.connectors.athena.jdbc.mariadb.MariaDbMetadataHandler;
import com.amazonaws.connectors.athena.jdbc.mariadb.MariaDbRecordHandler;
...
public final class JDBCUtil
{
    ...
    private static JdbcMetadataHandler createJdbcMetadataHandler(final DatabaseConnectionConfig databaseConnectionConfig)
    {
        switch (databaseConnectionConfig.getType()) {
            case MARIADB:
                return new MariaDbMetadataHandler(databaseConnectionConfig);
            case MYSQL:
    ...
    private static JdbcRecordHandler createJdbcRecordHandler(final DatabaseConnectionConfig databaseConnectionConfig)
    {
        switch (databaseConnectionConfig.getType()) {
            case MARIADB:
                return new MariaDbRecordHandler(databaseConnectionConfig);
            case MYSQL:
